...
;(function($) {
	...
	var methods = {
		init: function(options) {
        	...
        	$('<a/>', { id: id + '-back-' + index, href: 'javascript:void(0);', 'class': 'btn btn-info', 'style': 'float: left', html: opt.backLabel }).click(function() {
        	...
        	$('<a/>', { id: id + '-next-' + index, href: 'javascript:void(0);', 'class': 'btn btn-success', 'style': 'float: right', html: opt.nextLabel }).click(function() {
